...
void plot()
{
    ...
    TFile *f_mzp1 = TFile::Open("MZp600MA0300.root"); //dm=10
    TFile *f_mzp2 = TFile::Open("MZp1000MA0300.root"); //old
    TFile *f_mzp3 = TFile::Open("MZp1700MA0300.root");
...
//h_cosThetaStar;h_cosPhi;h_Bm0;h_BmT0;h_BmT1;h_By0;h_By1
    ...
    h_A0m3->SetAxisRange(0,1000,"X");
    h_A0m3->SetAxisRange(0,0.45,"y");
    ...
    leg->AddEntry(h_A0m1,"MZ'_600GeV,MA0_300GeV");
    leg->AddEntry(h_A0m2,"MZ'_1000GeV,MA0_300GeV");
    leg->AddEntry(h_A0m3,"MZ'_1700GeV,MA0_300GeV");
